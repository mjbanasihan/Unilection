...
<body>
            ...
            <li class="hideOnMobile">
                <span class="nav-link">Ballots</span>
                    <ul class="dropdown">
                        ...
                        <li><a href="">Finished Ballots</a></li>
                    </ul>
    ...
    <div id="votingResultsContainer" style="width: 80%; margin: auto; padding-top: 20px;">
        <table id="votingResultsTable">
            <thead>
                <tr>
                    <th>Student ID</th>
                    <th>Student Name</th>
            ...
            <tbody>
                <!-- Voting results will be inserted here dynamically -->
            </tbody>
        </table>
    </div>

    <script>
        // Function to fetch voting results for a selected ballot
        function fetchVotingResults(ballotId) {
            ...
            .then(data => displayVotingResults(data))
            .catch(error => console.error('Error fetching voting results:', error));
        }

        // Function to display the voting results in a table
        function displayVotingResults(data) {
            const tableBody = document.getElementById('votingResultsTable').querySelector('tbody');
